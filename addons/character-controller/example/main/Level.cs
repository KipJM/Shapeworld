...
public partial class Level : Node3D
{
    ...
    public override void _Ready()
    {
        ...
        if (FastClose)
        {
            ...
            GD.Print("** 'Shift + F1' to close 'Esc' to release mouse **");
        }
    ...
    {
        if (@event.IsActionPressed("change_mouse_input")) // TODO: THESE ARE SWAPPED
        {
            GetTree().Quit(); // Quits the game
        }

        if (@event.IsActionPressed("ui_cancel")) // TODO: THESE ARE SWAPPED
        {
